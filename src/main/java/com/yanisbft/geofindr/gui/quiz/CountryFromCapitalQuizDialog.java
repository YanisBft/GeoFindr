...
import com.yanisbft.geofindr.quiz.CountryFromCapitalQuiz;
...
public class CountryFromCapitalQuizDialog extends AbstractQuizDialog<City, Country> {
    private final JComboBox<Country> answer;

    public CountryFromCapitalQuizDialog(Gui parent, int questionCount) {
        super(parent, I18n.translate("quiz.country_from_capital"), new CountryFromCapitalQuiz(questionCount));
    ...
    @Override
    protected void showNextQuestion(Question<City, Country> nextQuestion) {
